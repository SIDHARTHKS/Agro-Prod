    ...
    body: Stack(
      children: [
        ...
        if (backgroundOverlayColor != null)
          Positioned.fill(
            child: Container(color: backgroundOverlayColor),
          ),
        ...
        if (backgroundImage == null)
          Positioned.fill(
            child: Container(
              color: bgcolor ?? AppColorHelper().backgroundColor,
            ),
          ),
...
SizedBox appContainer({
  ...
  boxDecoration = switch (AppEnvironment.appClient) {
    AppClient.agro => BoxDecoration(color: AppColorHelper().transparentColor),
  };
  return SizedBox(
    height: Get.height,
    width: Get.width,
...
Row doubleArrowSfxText(String text) {
  ...
  color = switch (AppEnvironment.appClient) {
    AppClient.agro => AppColorHelper().textColor,
  };
  return Row(
...
Image logoImage() {
  ...
  imagePath = switch (AppEnvironment.appClient) {
    AppClient.agro => Assets.images.muziriswhite.path,
  };
  return Image.asset(
    imagePath,
    width: 200,
